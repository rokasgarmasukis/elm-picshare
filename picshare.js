...
var $author$project$Picshare$viewDeailtedPhoto = F2(
...
var $author$project$Picshare$main = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					A2($author$project$Picshare$viewDeailtedPhoto, $author$project$Picshare$baseUrl + '1.jpg', 'Surfing'),
					A2($author$project$Picshare$viewDeailtedPhoto, $author$project$Picshare$baseUrl + '2.jpg', 'The Fox'),
					A2($author$project$Picshare$viewDeailtedPhoto, $author$project$Picshare$baseUrl + '3.jpg', 'Evening')
				]))
		]));
